...
export function mapRoute(
    ...
    const contentTypes = ['application/json', 'multipart/form-data', 'text/plain'];
    ...
    schema[path]![method.toLowerCase() as OpenAPIV3.HttpMethods] = {
        ...((headerSchema || paramsSchema || querySchema || bodySchema) ? ({parameters} as any) : {}) satisfies OpenAPIV3.ParameterObject,
...
export async function exportOpenAPI(app: Grace, extra: Partial<OpenAPIV3.Document> = {}) {
