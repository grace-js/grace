...
export type Route<
  ...
  ContextSchema = Context<
    Body extends TSchema ? Static<Body> : any,
    Query extends TSchema ? Static<Query> : Record<string, string>,
    Params extends TSchema ? Static<Params> : Record<string, string>,
    Headers extends TSchema ? Static<Headers> : Headers,
    ContextExtras
  >,
> = {
...
export type InferContext<R extends AnyRoute> = R extends Route<
  any,
  any,
  any,
  any,
...
>
  ? ContextSchema
  : never;
export type InferResponse<R extends AnyRoute> = R extends Route<
  any,
  any,
  any,
  infer Response,
...
export function createRouteTemplate<ContextExtras extends ContextExtra>({
  ...
  before?: Array<
    BeforeRoute<Route<any, any, any, any, any, any, any, ContextExtras>>
  >;
  after?: Array<
    AfterRoute<Route<any, any, any, any, any, any, any, ContextExtras>>
  >;
  schema?: {
    body?: TSchema;
    query?: TSchema;
