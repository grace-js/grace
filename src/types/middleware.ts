...
export type BeforeRoute<Route extends AnyRoute> = (
  context: InferContext<Route>,
) => Promise<PossibleResponses<InferResponse<Route>> | void>;
export type AfterRoute<Route extends AnyRoute> = (
  context: InferContext<Route>,
  response: any,
) => Promise<void>;
